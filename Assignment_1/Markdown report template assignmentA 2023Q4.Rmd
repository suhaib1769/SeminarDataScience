...
In the present study, we aimed to investigate the effect of website version and portal type on the number of pages visited by users. 
...
\mu &= \alpha + \beta_{\text{session}} \cdot \text{session} + \beta_{\text{subject}} \cdot \text{subject} \\
\alpha &\sim \text{Normal}(0, 10) \\
