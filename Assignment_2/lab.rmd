...
```{r, echo=FALSE}
# filter all rows with TeD = "TeD1"
d_MS <- d_M[d_M$model == "MS", c("TrD1", "TrD2", "TrD3", "TrD4", "TrD5", "TrD6", "TrD7", "TrD8", "TeD", "score", "Sum")]
d_MN <- d_M[d_M$model == "MN", c("TrD1", "TrD2", "TrD3", "TrD4", "TrD5", "TrD6", "TrD7", "TrD8", "TeD", "score", "Sum")]
d_M1 <- d_M[d_M$model == "M1", c("TrD1", "TrD2", "TrD3", "TrD4", "TrD5", "TrD6", "TrD7", "TrD8", "TeD", "score", "Sum")]
d_M2 <- d_M[d_M$model == "M2", c("TrD1", "TrD2", "TrD3", "TrD4", "TrD5", "TrD6", "TrD7", "TrD8", "TeD", "score", "Sum")]
d_M3 <- d_M[d_M$model == "M3", c("TrD1", "TrD2", "TrD3", "TrD4", "TrD5", "TrD6", "TrD7", "TrD8", "TeD", "score", "Sum")]
d_MF <- d_M[d_M$model == "MF", c("TrD1", "TrD2", "TrD3", "TrD4", "TrD5", "TrD6", "TrD7", "TrD8", "TeD", "score", "Sum")]
score_sum_model <- lm(score~TrD1 + TrD2 + TrD3 + TrD4 + TrD5 + TrD6 + TrD7 + TrD8 + TeD, data=d_MS)
# print(summary(score_sum_model))
emm <- emmeans(score_sum_model, ~TrD1 * TrD2 * TrD3 * TrD4 * TrD5 * TrD6 * TrD7 * TrD8)
print(summary(emm))
```
